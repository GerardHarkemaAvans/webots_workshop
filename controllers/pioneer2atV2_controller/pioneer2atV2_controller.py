...
pinoneer = Pioneer3at(pioneer_node)
...
movement_states =[['isReady = pinoneer.moveForward(4)', 'isReady = timer.start(2)', 'isReady = timer.isReady()'],
                  ['isReady = pinoneer.rotateRight(1.5)', 'isReady = timer.start(1.5)', 'isReady = timer.isReady()'],
                  ['isReady = pinoneer.moveForward(3)', 'isReady = timer.start(3)', 'isReady = timer.isReady()'],
                  ['isReady = pinoneer.moveForward(0)', 'isReady = timer.start(1.5)', 'isReady = timer.isReady()']]
